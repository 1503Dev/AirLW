...
public class CrashLoggerCore implements UncaughtExceptionHandler {
    private static CrashLoggerCore INSTANCE = new CrashLoggerCore();
    ...
    public static CrashLoggerCore getInstance() {
        return INSTANCE;
    }
    ...
    private boolean handleException(Throwable var1) {
        ...
        new Thread() {
            public void run() {
                Looper.prepare();
                Toast.makeText(CrashLoggerCore.this.mContext, "异常已记录\n/sdcard/logs/", 1).show();
                Looper.loop();
            }
        }.start();
    ...
    private String saveCrashInfo2File(Throwable var1) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals("mounted")) {
                String var14 = "/storage/emulated/0/logs/";
